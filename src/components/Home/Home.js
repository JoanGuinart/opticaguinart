...
/* import imgHome3 from "../../img/imgHome/pexels-ksenia-chernaya-5752243 1.png";
import imgHome4 from "../../img/imgHome/pexels-ksenia-chernaya-5752263 1.png";
import imgHome5 from "../../img/imgHome/pexels-ksenia-chernaya-5752319 1.png";
import imgHome6 from "../../img/imgHome/pexels-ksenia-chernaya-5766170 1.png"; */
    ...
    <div className="container containerGlobal">
      <div className="primeraLinea">
        <div className="columnaLeft ">
          ...
          <br />
          <a href="https://www.google.com/maps/place/Optica+Guinart/@41.4371149,2.1896783,15z/data=!4m2!3m1!1s0x0:0xa4b5922d46c1e48d?sa=X&ved=2ahUKEwjp6vPbsb37AhXR_7sIHTNCDeMQ_BJ6BAhSEAg" target="_blank" className="button1Home" rel="noreferrer">Visita'ns</a>
        </div>
        <div className="columnaRight ">
          <img src={imgHome1} alt="imagen1Home" className="imagen1Home" />
        </div>
      </div>
      ...
      <div className="segonaLinea row">
        <div className="col-5 linea2Col1">
          <img src={imgHome2} alt="imagen2Home" className="imagenHome2" />
        </div>
      ...
      <div className="terceraLinea row">
        ...
        <div className="col-3 contenedorGafa">
          ...
          <div className="imagenGafaLinea3Home">
            <img src={gafaHome} alt="Imagen gafa" className="fotoGafaLinea3Home" />
          </div>
          <br />
        ...
        <div className="col-3 contenedorGafa">
          <div className="tituloGafa">
            <p className="textoTitulo">LENTS DE CONTACTE</p>
          </div>
          <br />
          <div className="imagenGafaLinea3Home">
            <img src={lentillaHome} alt="Imagen gafa" className="fotoGafaLinea3Home" />
          </div>
          <br />
          <div className="containerButtonShopping">
        ...
        <div className="col-3 contenedorGafa">
          <div className="tituloGafa">
            <p className="textoTitulo">AUDIÒFONS</p>
          </div>
          <br />
          <div className="imagenGafaLinea3Home">
            <img src={audifonoHome} alt="Imagen gafa" className="fotoGafa" />
          </div>
          <br />
          <div className="containerButtonShopping">
            <Link to="/audiometria" className="buttonShopping1 buttonShoppingHome">
              Mès detalls
            </Link>
          </div>
        </div>
